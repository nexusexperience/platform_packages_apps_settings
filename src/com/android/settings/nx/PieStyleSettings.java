...
import android.preference.nxSeekBarPreference;
...
public class PieStyleSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieBackgroundAlpha = (nxSeekBarPreference) findPreference(PREF_PIE_BACKGROUND_ALPHA);
        ...
        mPieControlSize = (nxSeekBarPreference) findPreference(PREF_PIE_CONTROL_SIZE);
