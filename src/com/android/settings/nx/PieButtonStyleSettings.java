...
public class PieButtonStyleSettings extends SettingsPreferenceFragment implements
    ...
    nxSeekBarPreference mPieButtonAlpha;
    nxSeekBarPreference mPieButtonPressedAlpha;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieButtonAlpha =
                (nxSeekBarPreference) findPreference(PREF_PIE_BUTTON_ALPHA);
        mPieButtonAlpha.setOnPreferenceChangeListener(this);

        mPieButtonPressedAlpha =
                (nxSeekBarPreference) findPreference(PREF_PIE_BUTTON_PRESSED_ALPHA);
